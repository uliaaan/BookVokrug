...
<section id="edit-profile" class="section-with-space">
	<div class="container edit-profile-block">
		...
		<label>Логин</label>
		<input name="login" type="text" id="login" maxlength="30" class="form-control" placeholder="Логин" value="<? echo $userlogin ?>"><div class="reg-red-text"></div><br>
		<label>E-mail</label>
		...
		<button href="#fakelink" class="btn btn-success center-block">Применить</button>
	</div>
</section>
<? } else {
    header("Location: / ");
